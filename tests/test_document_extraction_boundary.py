...
def test_native_utf8_text_extraction_is_authorized_and_non_diagnostic(tmp_path):
    ...
    response = client.post(f"/api/v1/reports/{record_id}/extract-text")
...
def test_document_extraction_blocks_cross_patient_idor(tmp_path):
    ...
    denied = client.post(f"/api/v1/reports/{record_id}/extract-text")
...
def test_document_extraction_capabilities_are_truthful_and_authenticated(tmp_path):
    ...
    register_web(client, "patient", "extract-capabilities@example.com")
    login_web(client, "patient", "extract-capabilities@example.com")
    allowed = client.get("/api/v1/document-extraction/capabilities")
