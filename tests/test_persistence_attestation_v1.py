...
def test_explicit_operator_attestation_remains_authoritative():
    result = persistence_attestation(environment="development", engine="sqlite", durability="local_development", explicit_verified=True, require_durable_database=False, database_reachable=False, migrations_ready=False, schema_ready=False)
...
def test_runtime_attestation_never_self_verifies_sqlite():
    result = persistence_attestation(environment="production", engine="sqlite", durability="durable_configured", explicit_verified=False, require_durable_database=True, database_reachable=True, migrations_ready=True, schema_ready=True)
