...
PUBLIC_CRITICAL_GETS = ("/", "/login", "/register", "/healthz")
PATIENT_CRITICAL_GETS = (
    "/dashboard", "/finder", "/universal-search", "/ai?new=1", "/ai?mode=doctor&new=1",
    "/appointments", "/health-summary", "/timeline", "/records", "/health", "/health-access",
    "/messages", "/family", "/videos", "/profile",
)
