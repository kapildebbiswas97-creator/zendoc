...
def test_osm_element_remains_external_and_unbookable():
    result = _public_element({"type":"node","id":123,"lat":22.975,"lon":88.434,"tags":{"name":"Example Medical Store","amenity":"pharmacy","addr:city":"Kalyani","phone":"+91 00000 00000"}}, "pharmacy")
...
def test_overpass_provider_normalizes_fake_response_without_network(monkeypatch):
    ...
    monkeypatch.setattr(provider, "_post_overpass", lambda query: {"elements":[
