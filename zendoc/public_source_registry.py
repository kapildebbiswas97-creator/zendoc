...
SOURCES = {
    ...
    "kerala_health_institutions": PublicIngestionSource(
        source_id="kerala_health_institutions",
        name="Kerala Health Institution Directory",
        owner="Department of Health & Family Welfare / Directorate of Health Services, Government of Kerala",
        official_url="https://health.kerala.gov.in/institutionDetails",
        data_class="official_state_health_institution_directory",
        geography="KERALA",
        ingestion_types=("public_healthcare_entities",),
        trust_level="OFFICIAL_PUBLIC_DATA",
        live_fetch_status="PUBLIC_SEARCHABLE_DIRECTORY",
        personal_data_allowed=False,
        notes=(
            "Searchable official institution list with district, category, address/phone, sanctioned beds, "
            "functional beds, rural/urban flag, email and map. Bed counts are facility attributes, not real-time vacancy."
        ),
    ),
    "kerala_dhs_hospitals": PublicIngestionSource(
        source_id="kerala_dhs_hospitals",
        name="Kerala Directorate of Health Services - Hospitals",
        owner="Directorate of Health Services, Government of Kerala",
        official_url="https://dhs.kerala.gov.in/en/dhsw/",
        data_class="official_state_public_health_facility_directory",
        geography="KERALA",
        ingestion_types=("public_healthcare_entities",),
        trust_level="OFFICIAL_PUBLIC_DATA",
        live_fetch_status="PUBLIC_WEB_DIRECTORY",
        personal_data_allowed=False,
        notes="Official DHS categories including district/general/taluk hospitals, CHC, PHC, FHC, public health labs and specialty facilities.",
    ),
    "kerala_ehealth_hospitals": PublicIngestionSource(
        source_id="kerala_ehealth_hospitals",
        name="eHealth Kerala Hospital Search",
        owner="eHealth Kerala, Government of Kerala",
        official_url="https://ehealth.kerala.gov.in/portal/hospital-search",
        data_class="official_state_digital_hospital_directory",
        geography="KERALA",
        ingestion_types=("public_healthcare_entities",),
        trust_level="OFFICIAL_PUBLIC_DATA",
        live_fetch_status="PUBLIC_SEARCH_PORTAL",
        personal_data_allowed=False,
        notes="Use for public hospital discovery; patient records/appointments remain authenticated and must not be scraped.",
    ),
    "maharashtra_dmer_hospitals": PublicIngestionSource(
        source_id="maharashtra_dmer_hospitals",
        name="Maharashtra DMER Medical Colleges and Hospitals",
        owner="Directorate of Medical Education & Research, Government of Maharashtra",
        official_url="https://dmer.maharashtra.gov.in/english/medical-colleges-and-hospitals/",
        data_class="official_state_medical_college_hospital_directory",
        geography="MAHARASHTRA",
        ingestion_types=("public_healthcare_entities",),
        trust_level="OFFICIAL_PUBLIC_DATA",
        live_fetch_status="PUBLIC_TABLE_CSV_EXCEL",
        personal_data_allowed=False,
        notes="Official district/location/medical-college/attached-hospital table with CSV/Excel export.",
    ),
    "maharashtra_fda_drug_licenses": PublicIngestionSource(
        source_id="maharashtra_fda_drug_licenses",
        name="Maharashtra FDA Drug Licenses",
        owner="Food and Drug Administration, Government of Maharashtra",
        official_url="https://fda.maharashtra.gov.in/",
        data_class="official_state_drug_regulator_portal",
        geography="MAHARASHTRA",
        ingestion_types=("public_healthcare_entities",),
        trust_level="OFFICIAL_PUBLIC_DATA",
        live_fetch_status="PUBLIC_REGULATOR_PORTAL_XLN",
        personal_data_allowed=False,
        notes="State FDA exposes its drug-license portal/XLN workflow. Use public license lookup/export only where available; never infer live stock.",
    ),
    "karnataka_health_infrastructure": PublicIngestionSource(
        source_id="karnataka_health_infrastructure",
        name="Karnataka Health & Family Welfare Infrastructure Inventory",
        owner="Health & Family Welfare Services, Government of Karnataka",
        official_url="https://hfwcom.karnataka.gov.in/",
        data_class="official_state_health_infrastructure_reference",
        geography="KARNATAKA",
        ingestion_types=("public_healthcare_entities",),
        trust_level="OFFICIAL_PUBLIC_DATA",
        live_fetch_status="OFFICIAL_REPORT_REFERENCE",
        personal_data_allowed=False,
        notes=(
            "Official annual-report/reference inventory for district hospitals, taluk hospitals, CHCs, PHCs and other facilities. "
            "Treat as reference/coverage evidence unless a current facility-level export is available."
        ),
    ),
