...
AGENT_REGISTRY: dict[str, AgentDefinition] = {
    ...
    "CareAgent": AgentDefinition(
        ...
        allowed_tools=["find_contact", "get_appointment_summary", "share_report_with_consent", "create_followup_task"],
        allowed_actor_roles=ALL_ROLES,
    ...
    "PharmacyAgent": AgentDefinition(
        ...
        name="Pharmacy Agent",
        purpose="Medicine search and delivery requests.",
        allowed_tools=["find_contact"],
        allowed_actor_roles=["patient", "pharmacy", "admin"],
        risk_level="LOW_RISK",
        approval_requirements=[],
        status="beta",
        description="Medicine information and order intake. Dispensing requires pharmacy integration.",
    ),
