...
AGENT_REGISTRY: dict[str, AgentDefinition] = {
    ...
    "FitnessAgent": AgentDefinition(
        ...
        allowed_tools=["get_fitness_snapshot", "generate_fitness_plan"],
        allowed_actor_roles=["patient", "admin"],
        risk_level="READ_ONLY",
        approval_requirements=[],
        status="connected",
    ...
    "FamilyCareAgent": AgentDefinition(
        ...
        allowed_tools=["get_family_care_snapshot"],
        allowed_actor_roles=["patient", "admin"],
        risk_level="CONSENT_REQUIRED",
    ...
    "HomeHealthAgent": AgentDefinition(
        ...
        allowed_tools=["get_home_health_options", "confirm_home_health_request"],
        allowed_actor_roles=["patient", "doctor", "admin"],
        risk_level="LOW_RISK",
        approval_requirements=[],
    ...
    "TransportAgent": AgentDefinition(
        ...
        allowed_tools=["get_transport_options", "confirm_transport_request"],
        allowed_actor_roles=["patient", "doctor", "hospital", "admin"],
        risk_level="LOW_RISK",
        approval_requirements=[],
        status="integration_required",
